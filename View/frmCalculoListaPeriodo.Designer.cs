...
{
  partial class frmCalculoListaPeriodo
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCalculoListaPeriodo));
      ...
      this.cmdVariablesCalculo = new System.Windows.Forms.ToolBarButton();
      this.cmdVariablesCalculoDetalle = new System.Windows.Forms.ToolBarButton();
      ...
      this.toolBar1.Buttons.AddRange(new System.Windows.Forms.ToolBarButton[] {
            ...
            this.cmdPrint,
            this.cmdClose,
            this.cmdVariablesCalculo,
            this.cmdVariablesCalculoDetalle});
      ...
      this.cmdNew.Text = "&Procesar Cálculo";
      ...
      // cmdVariablesCalculo
      // 
      this.cmdVariablesCalculo.Enabled = false;
      this.cmdVariablesCalculo.ImageIndex = 12;
      this.cmdVariablesCalculo.Name = "cmdVariablesCalculo";
      this.cmdVariablesCalculo.Text = "Ver Variables del Cálculo Totalizadas";
      // 
      // cmdVariablesCalculoDetalle
      // 
      this.cmdVariablesCalculoDetalle.Enabled = false;
      this.cmdVariablesCalculoDetalle.ImageIndex = 12;
      this.cmdVariablesCalculoDetalle.Name = "cmdVariablesCalculoDetalle";
      this.cmdVariablesCalculoDetalle.Text = "Ver Variables de Cálculo a Detalle";
      // 
      // dataGridView1
      // 
      ...
      this.Name = "frmCalculoListaPeriodo";
      this.Text = "LISTA - CALCULO RETRIBUCIONES";
      this.Load += new System.EventHandler(this.frmCalculoLista_Load);
    ...
    private System.Windows.Forms.ToolBarButton cmdVariablesCalculo;
    private System.Windows.Forms.ToolBarButton cmdVariablesCalculoDetalle;
