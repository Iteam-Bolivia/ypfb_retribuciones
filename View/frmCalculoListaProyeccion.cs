...
{
    public partial class frmCalculoListaProyeccion : Form
    {
        long cal2_id;
        long ctt_id;
        long tcl_id;
        ...
        public frmCalculoListaProyeccion()
        {
            InitializeComponent();
        }

        /// <summary>
        /// Method frmCalculoListaProyeccion_Load
        /// </summary>
        private void frmCalculoListaProyeccion_Load(object sender, EventArgs e)
        {
            Cargar(listaCalculo);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.RowCount > 0)
            {
                ...
                // Edit Calculo
                frmCalculoProyeccion childForm = new frmCalculoProyeccion();
        ...
        private void toolBar1_ButtonClick(object sender, ToolBarButtonClickEventArgs e)
        {
            ...
            switch (button.Name)
            {
                case "cmdNew":
                    objSession.ID = 0;
                    frmCalculoBusquedaProyeccion.listaCalculos = null;
                    frmCalculoBusquedaProyeccion.flagBusqueda = 0;
                    frmCalculoProyeccion childForm = new frmCalculoProyeccion();
                    childForm.FormClosed += new FormClosedEventHandler(childForm_FormClosed);
                    childForm.ShowDialog(); ;
                    break;
                ...
                case "cmdEdit":
                    ...
                    frmCalculoBusquedaProyeccion.listaCalculos = null;
                    frmCalculoBusquedaProyeccion.flagBusqueda = 0;
                    frmCalculoProyeccion childForm2 = new frmCalculoProyeccion();
                ...
                case "cmdRefresh":
                    frmCalculoListaProyeccion_Load(sender, e);
                    break;

                case "cmdFind":
                    frmCalculoBusquedaProyeccion.listaCalculos = null;
                    frmCalculoBusquedaProyeccion.flagBusqueda = 0;
                    frmCalculoBusquedaProyeccion childForm6 = new frmCalculoBusquedaProyeccion();
        ...
        {
            //cargar();
            if (frmCalculoBusquedaProyeccion.flagBusqueda == 0)
            {
                Cargar(listaCalculo);
                frmCalculoBusquedaProyeccion.flagBusqueda = 0;
                frmCalculoBusquedaProyeccion.listaCalculos = null;
            ...
            {
                Cargar(frmCalculoBusquedaProyeccion.listaCalculos);
                frmCalculoBusquedaProyeccion.flagBusqueda = 0;
                frmCalculoBusquedaProyeccion.listaCalculos = null;
            }
        }
        ...
        private void Cargar(List<Calculo> lstCalculos)
        {
            ...
            if (lstCalculos == null)
            {
                ...
                // Default: 4: Proyecciones
                lstCalculos = objCalculoController.listbytcl(4);
            }
