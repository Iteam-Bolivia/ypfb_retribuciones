...
{
  public partial class frmCalculoVariableListaDetalle : Form
  {
    long ctt_id;
    long tcl_id;
    long mes2_id;
    ...
    /// <summary>
    /// Method frmCalculoVariableListaDetalle
    /// </summary>
    public frmCalculoVariableListaDetalle()
    {
      InitializeComponent();
    ...
    /// </summary>
    private void frmCalculoVariableListaDetalle_Load(object sender, EventArgs e)
    {
      cargar();
    }
    ...
    private void cargar()
    {
      ...
      lstCalculo = objCalculoVariableController.loadDetalle(ctt_id, tcl_id, ani2_id, mes2_id);
      if (lstCalculo.Count == 0)
      {
