namespace View
{
  partial class frmCredits
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.Text = "Desarrollado por Iteam S.R.L para YPFB";
      ...
      this.label2.Text = "Diseño y Programación: Arsenio Castellón, Max Soria, Freddy Velasco, Diego Calder" +
          "ón";
      ...
      this.label3.Text = "Coordinación General: Jorge Garzón";
