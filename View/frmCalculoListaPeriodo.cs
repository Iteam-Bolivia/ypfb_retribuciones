...
{
    public partial class frmCalculoListaPeriodo : Form
    {
        long cal2_id;
        long ctt_id;
        long tcl_id;
        ...
        public frmCalculoListaPeriodo()
        {
            InitializeComponent();
        }

        /// <summary>
        /// Method frmCalculoLista_Load
        /// </summary>
        private void frmCalculoLista_Load(object sender, EventArgs e)
        {
            Cargar(listaCalculo);
        ...
        private void dataGridView1_Click(object sender, EventArgs e)
        {
            ...
            if (tcl_codigo2 != "" && tcl_codigo2 != null)
            {
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            // Edit Calculo
            frmCalculoManualPeriodo childForm = new frmCalculoManualPeriodo();
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
          try
          {
            ...
            if ((String)this.dataGridView1.Rows[e.RowIndex].Cells[3].Value == "RETRIBUCIÓN RECÁLCULO" || (String)this.dataGridView1.Rows[e.RowIndex].Cells[3].Value == "RECÁLCULO")
            {
            ...
            if ((String)this.dataGridView1.Rows[e.RowIndex].Cells[3].Value == "RETRIBUCIÓN A CUENTA" || (String)this.dataGridView1.Rows[e.RowIndex].Cells[3].Value == "A CUENTA")
            {
              foreach (DataGridViewCell celda in this.dataGridView1.Rows[e.RowIndex].Cells)
              {
                if (celda.ColumnIndex == 3)
        ...
        private void toolBar1_ButtonClick(object sender, ToolBarButtonClickEventArgs e)
        {
            ...
            switch (button.Name)
            {
                case "cmdNew":
                    objSession.ID = 0;
                    frmCalculoBusqueda.listaCalculos = null;
                    frmCalculoBusqueda.flagBusqueda = 0;
                    frmCalculoManualPeriodo childForm = new frmCalculoManualPeriodo();
                    childForm.FormClosed += new FormClosedEventHandler(childForm_FormClosed);
                    childForm.ShowDialog();
                    break;
                ...
                case "cmdEdit":
                    ...
                    frmCalculoBusqueda.listaCalculos = null;
                    frmCalculoBusqueda.flagBusqueda = 0;
                    frmCalculoManualPeriodo childForm2 = new frmCalculoManualPeriodo();
                ...
                case "cmdRefresh":
                    frmCalculoLista_Load(sender, e);
                    break;

                case "cmdFind":
                    frmCalculoBusqueda.listaCalculos = null;
                    frmCalculoBusqueda.flagBusqueda = 0;
                    frmCalculoBusqueda childForm6 = new frmCalculoBusqueda();
                ...
                case "cmdVariablesCalculo":
                    objSession.ID = ctt_id;
                    objSession.TCL_ID = tcl_id;
                    objSession.MES_ID = mes_id;
                    objSession.ANI_ID = ani_id;

                    frmCalculoVariableLista childForm4 = new frmCalculoVariableLista();
                    childForm4.FormClosed += new FormClosedEventHandler(childForm_FormClosed);
                    childForm4.ShowDialog();
                    break;


                case "cmdVariablesCalculoDetalle":
                    objSession.ID = ctt_id;
                    objSession.TCL_ID = tcl_id;
                    objSession.MES_ID = mes_id;
                    objSession.ANI_ID = ani_id;

                    frmCalculoVariableListaDetalle childForm5 = new frmCalculoVariableListaDetalle();
                    childForm5.FormClosed += new FormClosedEventHandler(childForm_FormClosed);
                    childForm5.ShowDialog();
                    break;
        ...
        {
            //cargar();
            if (frmCalculoBusqueda.flagBusqueda == 0)
            {
                Cargar(listaCalculo);
                frmCalculoBusqueda.flagBusqueda = 0;
                frmCalculoBusqueda.listaCalculos = null;
            ...
            {
                Cargar(frmCalculoBusqueda.listaCalculos);
                frmCalculoBusqueda.flagBusqueda = 0;
                frmCalculoBusqueda.listaCalculos = null;
            }
        }
