...
{
    public partial class RepDistribRet : Form
    {
        public RepDistribRet()
        {
            InitializeComponent();
        }
        ...
        private void CargarContratos()
        {
            try
            {
                ...
                ds = rptRedis.fillDataSetRepParticipacion("fnc_distri_titular_campos", "DistribDataTable", mes_ini, anio_ini, tcl_id);
