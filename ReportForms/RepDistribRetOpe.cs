...
{
    public partial class RepDistribRetOpe : Form
    {
        public RepDistribRetOpe()
        {
            InitializeComponent();
        }

        private void RepDistribRetOpe_Load(object sender, EventArgs e)
        {
        ...
        private void CargarContratos()
        {
            try
            {
                ...
                ds = rptRedis.fillDataSetResumenEjec("fnc_distribretope", "DistribRetOpeDataTable", mes_ini, anio_ini);
